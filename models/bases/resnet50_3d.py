...
class ResNet3D(nn.Module):
    ...
    def load_2d(self, model2d):
        ...
        print('yahi hon raha hai!')
        #print("sd",sd)
        #print("sd2d",sd2d)
        sd = OrderedDict([('module.'+x, y) for x, y in sd.items()])
        sd2d = OrderedDict([('module.'+x, y) for x, y in sd2d.items()])
        #print(sd2d)
...
if __name__ == "__main__":
    ...
    #dit1 = model.state_dict()
    #print("model dict ",dit1.keys())
    model = model.cuda()
